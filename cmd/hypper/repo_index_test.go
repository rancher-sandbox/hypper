...
func TestRepoIndexCmd(t *testing.T) {
	...
	comp := filepath.Join(dir, "vanilla-helm-compressedchart-0.1.0.tgz")
	if err := linkOrCopy("testdata/testcharts/vanilla-helm-compressedchart-0.1.0.tgz", comp); err != nil {
		t.Fatal(err)
	}
	comp2 := filepath.Join(dir, "vanilla-helm-compressedchart-0.2.0.tgz")
	if err := linkOrCopy("testdata/testcharts/vanilla-helm-compressedchart-0.2.0.tgz", comp2); err != nil {
		t.Fatal(err)
	}
	...
	if err := linkOrCopy("testdata/testcharts/vanilla-helm-reqtest-0.1.0.tgz", filepath.Join(dir, "vanilla-helm-reqtest-0.1.0.tgz")); err != nil {
		t.Fatal(err)
	}
	if err := linkOrCopy("testdata/testcharts/vanilla-helm-compressedchart-0.3.0.tgz", filepath.Join(dir, "vanilla-helm-compressedchart-0.3.0.tgz")); err != nil {
		t.Fatal(err)
	}
