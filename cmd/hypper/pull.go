...
func newPullCmd(cfg *action.Configuration, logger log.Logger) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			// Required to pass a helm cli.Settings because the downloader needs it
			client.Settings = settings.EnvSettings
